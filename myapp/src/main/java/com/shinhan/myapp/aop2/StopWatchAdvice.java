...
//보조업무(Advice)...Spring이 보조업무를 주업무에 넣어준다.
@Component
@Aspect
public class StopWatchAdvice{
	//com.shinhan.myapp.aop2.Calculator클래스 내의 모든 메서드에 StopWatchAdvice 보조업무가 적용된다.
	//주업무 전후에 StopWatch기능이 들어간다.
	@Pointcut("Within(com.shinhan.myapp.aop2.Calculator)")
